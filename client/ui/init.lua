...
function ui.test_scene()
	...
	root:give("UiElement")
	root:give("UiTransform", Vector2.new(16, 16), Vector2.new(400, 600))
	...
	header:give("UiTransform", Vector2.new(0, 0), Vector2.new(380, 40))
	...
	buttonContainer:give("UiTransform", Vector2.new(0, 0), Vector2.new(380, 200))
	...
	btn1:give("UiTransform", Vector2.new(0, 0), Vector2.new(360, 40))
	...
	btn2:give("UiTransform", Vector2.new(0, 0), Vector2.new(360, 40))
