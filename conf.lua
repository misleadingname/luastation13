function love.conf(t)
    t.identity = "ls13"                 -- The name of the save directory (string)
    ...
    t.window.title = "Lua Station 13"   -- The window title (string)
    t.window.icon =
    "/resources/textures/core/icon.png" -- Filepath to an image to use as the window's icon (string)
